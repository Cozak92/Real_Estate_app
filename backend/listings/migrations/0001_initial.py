    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sale_type', models.CharField(choices=[('매매', 'For Sale'), ('월세', 'For Rent'), ('전세', 'For Prent')], default='매매', max_length=50)),
                ('price', models.IntegerField()),
                ('bedrooms', models.IntegerField()),
                ('bathrooms', models.DecimalField(decimal_places=1, max_digits=2)),
                ('home_type', models.CharField(choices=[('주택', 'House'), ('빌라', 'Villa'), ('오피스텔', 'Officetels'), ('아파트', 'Apt')], default='주택', max_length=50)),
